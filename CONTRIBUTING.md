# Contributing to gluedown

This outlines how to propose a change to gluedown. For more detailed
...
Code of Conduct](https://k5cents.github.io/gluedown/CODE_OF_CONDUCT.md).
