...
#' @details From the [GFM spec](https://github.github.com/gfm/#block-quote-marker): A block quote
#'   marker consists of 0-3 spaces of initial indent, plus (a) the character `>` together with a
...
#' @return A character vector with a greater-than symbol (`>`) prepended to each element.
#' @examples
