...
#'   link reference definition consists of a
#'   [link label](https://github.github.com/gfm/#link-label), indented up to three spaces, followed
#'   by a colon (`:`), optional [whitespace](https://github.github.com/gfm/#whitespace) (including
#'   up to one [line ending](https://github.github.com/gfm/#line-ending)), a
#'   [link destination](https://github.github.com/gfm/#link-destination), optional whitespace
#'   (including up to one line ending), and an optional
#'   [link title](https://github.github.com/gfm/#link-title), which if it is present must be
#'   separated from the link destination by whitespace. No further
#'   [non-whitespace characters](https://github.github.com/gfm/#non-whitespace-character) may occur
#'   on the line.
...
#' @details From the [GFM spec](https://github.github.com/gfm/#inline-link): An inline link
#'   consists of a [link text](https://github.github.com/gfm/#link-text) followed immediately by a
#'   left parenthesis `(`... an optional link destination, an optional link title separated from
