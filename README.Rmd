...
The `gluedown` package helps wrap character vectors in markdown syntax. Markdown is a lightweight
technique for formatting text. Markdown is prevalent in R coding; this package helps transition
from raw R vectors and formatted Markdown.
...
in combination with the `results='asis'` R Markdown chunk option to directly print markdown blocks.
