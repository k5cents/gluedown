...
[GitHub task lists][task] are supported, with the ability to adjust checks.
...
Here, we also see how _inline_ functions (e.g., `md_bold`) can be used within _block_ functions
(e.g., `md_bullet()`).
