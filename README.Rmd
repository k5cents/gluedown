...
valid markdown syntax. In combination with the [`knitr`][knitr] package, this
...
`knitr` chunk option; this allows users to directly print formatted text from a
...
[pipes][pipe]. Chain together some code and print the results.
