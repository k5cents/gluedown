...
the markdown standard. Using the `rvest` package, we can programatically scrape
...
In the rest of this vigette, I will demonstrate some of the various use cases
...
five states each formatted in another sytax. We'll take a look at what that
...
can seemlessly create content with their code and display that content with
...
the results of one function into the begining of the next. By ending this
...
[forced by pandoc][pandoc]. For example, the output of `md_define()` will be 
